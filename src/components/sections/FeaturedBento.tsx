    ...
    <section id="projects" className="relative py-28 md:py-36 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.035] pointer-events-none select-none" aria-hidden="true">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M-100 200 L 300 600 M1200 100 L 1500 400 M600 800 L 900 1100" stroke="#6366f1" strokeWidth="1.5" strokeDasharray="5 5" />
          <path d="M200 100 L 250 150 L 500 150" stroke="#818cf8" strokeWidth="1" fill="none" />
          <path d="M1000 700 L 1050 750 L 1300 750" stroke="#818cf8" strokeWidth="1" fill="none" />
        </svg>
      </div>
            ...
            {FILTERS.map((f) => {
              ...
              return (
                <button
                  ...
                  style={{
                    boxShadow: isActive ? '0 0 20px rgba(99, 102, 241, 0.1)' : undefined
                  }}
                >
